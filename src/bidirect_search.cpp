...
std::string mirror_pattern(const char* compares,
                           size_t num_compares,
                           size_t pattern_size)
{
...
std::pair<std::string, std::string> get_dna_rna_match(const char* compares,
                                                      size_t pattern_size,
                                                      const GenomeMatch* gm)
{
    std::string rna =
