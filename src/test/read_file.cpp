...
{
    TwoBitReader* reader =
      create_2bit_reader("../cas-offinder/src/test/t_data/upstream1000.2bit");
    ...
    ifstream file("../cas-offinder/src/test/t_data/expected.txt");
    buffer << file.rdbuf();
...
{
    FastaReader* reader =
      create_fasta_reader("../cas-offinder/src/test/t_data/upstream1000.fa");
    assert(reader && "test file does not exist!");
    ChromData data;
    vector<uint64_t> chrompos;
    vector<string> chromnames;
...
{
    FolderReader* reader =
      create_folder_reader("../cas-offinder/src/test/t_data/");
    assert(reader && "test file does not exist!");
    ChromData data;
    vector<uint64_t> chrompos;
    vector<string> chromnames;
